...
(function($) {
  ...
  $('.quick-links.list a.options').live('click', function(event) {
    var id, uri;
  ...
  $('table.quicklinks a[href*="links/move"]').live('click', function(event) {
    var href,
      _this = this;
    event.preventDefault();
  ...
  $('table.quicklinks select[name=action]').live('change', function() {
    return $(this).next().attr('disabled', !$(this).val());
  });
  return $(document).ready(function() {
    return $('table.quicklinks select[name=action]').change();
  });
})(jQuery);
