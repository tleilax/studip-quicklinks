...
(function($) {
  ...
  $('.quick-links.list :checkbox').live('click', function() {
    ...
    return $.post(uri, params, (function(_this) {
  ...
  $('.quick-links.list :not(:trigger) a.options').live('click', function(event) {
    var id, uri;
  ...
  return $('table.quicklinks a[href*="links/move"]').live('click', function(event) {
    var href;
    event.preventDefault();
